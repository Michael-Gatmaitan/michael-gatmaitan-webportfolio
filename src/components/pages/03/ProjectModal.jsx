...
const ProjectModal = (props) => {
  ...
  */
  ...
  const closeModal = (e) => {
    ...
    if (
      !(
        targetClass === "project-modal-container" ||
        targetClass === "close-project-modal"
      )
    )
      return;
  ...
  const modalOnScroll = (e) => {
    ...
    barWidth =
      (e.currentTarget.scrollLeft / (totalScrollWidth - viewableWidth)) * 100;
      ...
      {Array(gallerySnips)
        ...
        .map((e, i) => (
          <div className='slider-container' key={i}>
            <img
              src={`./images/project-gallery/${galleryDirectory}/${imageName}${
                i + 1
              }.jpg`}
              alt='project_image'
              loading='lazy'
